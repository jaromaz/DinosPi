...
git clone --branch dev https://github.com/udo-munk/z80pack.git $Z_DIR

[ $? -ne 0 ] && net_error "z80pack git"

( cd $Z_DIR && git checkout 3d5d2afdaf7131fe7eb765718f0d2144388051f3 )
...
make
sudo cp mkdskimg bin2hex cpmsend cpmrecv ptp2bin /usr/bin
make clean
